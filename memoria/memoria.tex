...
\begin{sidewaysfigure}[H]
  ...
  \begin{tabular}{cccccc}
    {\includegraphics[width=.014\textwidth,clip=true,trim={0 .59cm 9cm 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_linf_u2_C7_gaussian_kernel_shape_0.78125_Poly-1.pdf}} & {\includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_linf_u2_C7_gaussian_kernel_shape_0.78125_Poly-1.pdf}}      & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_linf_u2_C11_gaussian_kernel_shape_1.5625_Poly-1.pdf}  & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_linf_u2_C15_gaussian_kernel_shape_2.5_Poly-1.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_linf_u2_C20_gaussian_kernel_shape_3.6621_Poly-1.pdf}  & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_linf_u2_C30_gaussian_kernel_shape_5.6152_Poly-1.pdf}      \\
    {\includegraphics[width=.014\textwidth,clip=true,trim={0 .59cm 9cm 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_l2_u2_C7_gaussian_kernel_shape_0.78125_Poly-1.pdf}}   & {\includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 .65cm}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_l2_u2_C7_gaussian_kernel_shape_0.78125_Poly-1.pdf}}  & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 .65cm}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_l2_u2_C11_gaussian_kernel_shape_1.5625_Poly-1.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 .65cm}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_l2_u2_C15_gaussian_kernel_shape_2.5_Poly-1.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 .65cm}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_l2_u2_C20_gaussian_kernel_shape_3.6621_Poly-1.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 .65cm}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_l2_u2_C30_gaussian_kernel_shape_5.6152_Poly-1.pdf}  \\
    {\includegraphics[width=.014\textwidth,clip=true,trim={0 0 9cm 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_times_u2_C7_gaussian_kernel_shape_0.78125_Poly-1.pdf}}    & {\includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_times_u2_C7_gaussian_kernel_shape_0.78125_Poly-1.pdf}}   & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_times_u2_C11_gaussian_kernel_shape_1.5625_Poly-1.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_times_u2_C15_gaussian_kernel_shape_2.5_Poly-1.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_times_u2_C20_gaussian_kernel_shape_3.6621_Poly-1.pdf}  & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_times_u2_C30_gaussian_kernel_shape_5.6152_Poly-1.pdf} 
  \end{tabular}
...
\begin{figure}
  \includegraphics[width=.5\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/distribution_of_errors_L_inf_end.pdf}
...
\begin{figure}
  \includegraphics[width=\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/C7-TR28.pdf}
  \label{fig:u2-results-shapes-etc-c7-tr28}
\end{figure}


\begin{figure}
  \includegraphics[width=\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/C11-TR44.pdf}
  \caption{Box plots of shapes and coefficients.}
  \label{fig:u2-results-shapes-etc-c11-tr44}
\end{figure}
...
\begin{figure}
  ...
  \caption{Box plots of shapes and coefficients.}
  \label{fig:u2-results-shapes-etc-c15-tr60}
\end{figure}

\begin{figure}
  \includegraphics[width=\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/C20-TR80.pdf}
  \caption{Box plots of shapes and coefficients.}
  \label{fig:u2-results-shapes-etc-c20-tr80}
\end{figure}

\begin{figure}
  \includegraphics[width=\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/C30-TR120.pdf}
  \caption{Box plots of shapes and coefficients.}
...
Irrespectively of the number of centers that one considers, the case $k=4$ provides the best results in the quality metrics that we have considered thus far. The consideration of polynomial addends does not decisively improve our quality metrics. 

For these reasons, in the following we shall be posing and solving some problems on function approximation and differential equations for the sets of centers we introduced for the 1D and 2D cases, albeit restricting ourselves to the case $k=4$ to ensure we obtain the best results right off the bat. 
...
\begin{figure}
  ...
  \includegraphics[width=.45\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/runge_function/violins_l2_runge_function_endgame_2.pdf}
  \caption{Quality metrics on the verification dataset for \texttt{runge\_function}, across all centers.}
\end{figure}

\begin{figure}
  \includegraphics[width=.5\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/runge_function/distribution_of_errors_L_inf_end_runge_function.pdf}
\end{figure}
...
\begin{figure}
  \includegraphics[width=\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/runge_function/C7-TR28-runge_function.pdf}
\end{figure}
\begin{figure}
  \includegraphics[width=\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/runge_function/C11-TR44-runge_function.pdf}
\end{figure}
\begin{figure}
  \includegraphics[width=\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/runge_function/C15-TR60-runge_function.pdf}
\end{figure}
\begin{figure}
  \includegraphics[width=\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/runge_function/C20-TR80-runge_function.pdf}
\end{figure}
  \begin{figure}
  \includegraphics[width=\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/runge_function/C30-TR120-runge_function.pdf}  
\end{figure}
...
\begin{figure}
  ...
  \includegraphics[width=.45\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/arctan_paper/violins_l2_arctan_paper_endgame_2.pdf}
  \caption{Quality metrics on the verification dataset for \texttt{arctan}, across all centers.}
\end{figure}

\begin{figure}
  \includegraphics[width=.5\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/arctan_paper/distribution_of_errors_L_inf_end_arctan_paper.pdf}
\end{figure}
...
\begin{figure}
  \includegraphics[width=\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/arctan_paper/C7-TR28-arctan_paper.pdf}
\end{figure}
\begin{figure}
  \includegraphics[width=\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/arctan_paper/C11-TR44-arctan_paper.pdf}
\end{figure}
\begin{figure}
  \includegraphics[width=\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/arctan_paper/C15-TR60-arctan_paper.pdf}
\end{figure}
\begin{figure}
  \includegraphics[width=\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/arctan_paper/C20-TR80-arctan_paper.pdf}
\end{figure}
  \begin{figure}
  \includegraphics[width=\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/arctan_paper/C30-TR120-arctan_paper.pdf}  
\end{figure}

\begin{figure}
  \includegraphics[width=\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/arctan_paper/distribution_of_shape_parameters-arctan_paper.pdf}
\end{figure}
...
\begin{figure}
  ...
  \includegraphics[width=.45\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/sin_cube_tref/violins_l2_sin_cube_tref_endgame_2.pdf}
  \caption{Quality metrics on the verification dataset for \texttt{sin\_cube\_tref}, across all centers.}
\end{figure}

\begin{figure}
  \includegraphics[width=.5\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/sin_cube_tref/distribution_of_errors_L_inf_end_sin_cube_tref.pdf}
\end{figure}
...
\begin{figure}
  \includegraphics[width=\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/sin_cube_tref/C7-TR28-sin_cube_tref.pdf}
\end{figure}
\begin{figure}
  \includegraphics[width=\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/sin_cube_tref/C11-TR44-sin_cube_tref.pdf}
\end{figure}
\begin{figure}
  \includegraphics[width=\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/sin_cube_tref/C15-TR60-sin_cube_tref.pdf}
\end{figure}
\begin{figure}
  \includegraphics[width=\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/sin_cube_tref/C20-TR80-sin_cube_tref.pdf}
\end{figure}
  \begin{figure}
  \includegraphics[width=\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/sin_cube_tref/C30-TR120-sin_cube_tref.pdf}  
\end{figure}

\begin{figure}
  \includegraphics[width=\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/sin_cube_tref/distribution_of_shape_parameters-sin_cube_tref.pdf}
\end{figure}
...
\begin{figure}
  ...
  \includegraphics[width=.45\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/sin_pi_x_sq/violins_l2_sin_pi_x_sq_endgame_2.pdf}
  \caption{Quality metrics on the verification dataset for \texttt{sin\_pi\_x\_sq}, across all centers.}
\end{figure}

\begin{figure}
  \includegraphics[width=.5\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/sin_pi_x_sq/distribution_of_errors_L_inf_end_sin_pi_x_sq.pdf}
\end{figure}
...
\begin{figure}
  \includegraphics[width=\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/sin_pi_x_sq/C7-TR28-sin_pi_x_sq.pdf}
\end{figure}
\begin{figure}
  \includegraphics[width=\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/sin_pi_x_sq/C11-TR44-sin_pi_x_sq.pdf}
\end{figure}
\begin{figure}
  \includegraphics[width=\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/sin_pi_x_sq/C15-TR60-sin_pi_x_sq.pdf}
\end{figure}
\begin{figure}
  \includegraphics[width=\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/sin_pi_x_sq/C20-TR80-sin_pi_x_sq.pdf}
\end{figure}
  \begin{figure}
  \includegraphics[width=\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/sin_pi_x_sq/C30-TR120-sin_pi_x_sq.pdf}  
\end{figure}

\begin{figure}
  \includegraphics[width=\textwidth]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/sin_pi_x_sq/distribution_of_shape_parameters-sin_pi_x_sq.pdf}
\end{figure}
...
\begin{figure}
  \includegraphics[width=\textwidth]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/runge_2d/runge_2d-TR22-C121-Kgaussian_kernel-Sh2.5635-4-E50574.pdf}
...
\begin{figure}[h]
  \hspace*{-2cm}
  \begin{tabular}{ccc}
    {\includegraphics[width=.4\textwidth]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/runge_2d/distribution_of_errors_L_inf_49_runge_2d.pdf}} &
    \includegraphics[width=.4\textwidth]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/runge_2d/distribution_of_errors_L_inf_81_runge_2d.pdf}   &
    \includegraphics[width=.4\textwidth]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/runge_2d/distribution_of_errors_L_inf_121_runge_2d.pdf}    \\
    \includegraphics[width=.4\textwidth]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/runge_2d/distribution_of_errors_L_inf_169_runge_2d.pdf}  &
    \includegraphics[width=.4\textwidth]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/runge_2d/distribution_of_errors_L_inf_225_runge_2d.pdf}  &
    \includegraphics[width=.4\textwidth]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/runge_2d/distribution_of_errors_L_inf__runge_2d.pdf}
  \end{tabular}
  \caption{Distribution of the largest errors at the end of the training process according to the number of centers and overall.}
  \label{fig:runge-2d-results-largest-errors}
\end{figure}
...
\begin{figure}[h]
  \hspace*{-2cm}
  \begin{tabular}{ccc}
    {\includegraphics[width=.4\textwidth]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/arctan_2d/distribution_of_errors_L_inf_49_arctan_paper_2d.pdf}} &
    \includegraphics[width=.4\textwidth]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/arctan_2d/distribution_of_errors_L_inf_81_arctan_paper_2d.pdf}   &
    \includegraphics[width=.4\textwidth]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/arctan_2d/distribution_of_errors_L_inf_121_arctan_paper_2d.pdf}    \\
    \includegraphics[width=.4\textwidth]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/arctan_2d/distribution_of_errors_L_inf_169_arctan_paper_2d.pdf}  &
    \includegraphics[width=.4\textwidth]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/arctan_2d/distribution_of_errors_L_inf_225_arctan_paper_2d.pdf}  &
    \includegraphics[width=.4\textwidth]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/arctan_2d/distribution_of_errors_L_inf__arctan_paper_2d.pdf}
  \end{tabular}
  \caption{Distribution of the largest errors at the end of the training process according to the number of centers and overall.}
  \label{fig:arctan-2d-results-largest-errors}
\end{figure}
