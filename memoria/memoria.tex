...
Figure \ref{fig:representation-domain-problem} shows a drawing of a possible distribution of nodes we can have with this sampling technique. The interior points are painted as black circles and the corner points are depicted as circumferences. Among the remaining points, boundary points for $t<1$ are painted in pink and the ones for $t=1$ are painted in green. We use this diagram to propose a variational formulation of of the parabolic PDE as follows.
