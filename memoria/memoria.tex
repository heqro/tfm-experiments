...
\begin{abstract}
  ...
  This thesis aims to explore the application of Radial Basis Function theory to contemporary Machine Learning techniques, focusing on the approximation of functions and the solution of differential equations. 

  To this end, the starting two chapters provide motivation and a review of key concepts from the relevant fields of study. The reader is then introduced to the notation, code bases and methodology, setting the stage for the experimental validation of the proposed model.

  The experimental work is divided into two phases, each described in a dedicated chapter. The first phase proposes a ``well-behaved'' problem, aiming to verify the soundness of the methodology. Upon successful verification, the second phase considers a set of relevant function approximation and differential problems, highlighting both the differences and similarities compared to the first phase.

  Once the experimental works are complete, the final chapter presents conclusions drawn from the experimental work and discusses future directions, addressing notable findings and potential limitations of the method.
...
enough to characterize any continuous function, that is, it is
  {\tmstrong{dense}} in the space of continuous functions of $n \text{
    variables } C (I_n)$, where $I_n$ denotes the unit $n-$dimensional cube. We briefly quote the terminology and formulation
...
% Incluir diagrama (sidewaysfigure) "Esta es la llave de la memoria", para explicar método numérico e implementación numérica.
% Considerar subsecciones para cada módulo.
% Utilizar la "filosofía" de "leer de izquierda a derecha". Líneas discontinuas pueden ayudar a clarificar cada módulo.
...
\begin{sidewaysfigure}[H]
  \hspace*{-1cm}
  \begin{tabular}{ccccc}
    {\includegraphics[width=.014\textwidth,clip=true,trim={0 .59cm 9cm 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_linf_u2_C7_gaussian_kernel_shape_0.78125_Poly-1.pdf}} & {\includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_linf_u2_C7_gaussian_kernel_shape_0.78125_Poly-1.pdf}}   & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_linf_u2_C11_gaussian_kernel_shape_1.5625_Poly-1.pdf}   & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_linf_u2_C15_gaussian_kernel_shape_2.5_Poly-1.pdf}   & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_linf_u2_C20_gaussian_kernel_shape_3.6621_Poly-1.pdf}   \\
    {\includegraphics[width=.014\textwidth,clip=true,trim={0 .59cm 9cm 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_linf_u2_C7_gaussian_kernel_shape_0.78125_Poly-1.pdf}} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_linf_u2_C30_gaussian_kernel_shape_5.6152_Poly-1.pdf}   & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_linf_u2_C40_gaussian_kernel_shape_7.8125_Poly-1.pdf}  & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_linf_u2_C50_gaussian_kernel_shape_9.7656_Poly-1.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_linf_u2_C60_gaussian_kernel_shape_11.7188_Poly-1.pdf}   \\ \hline
     {\includegraphics[width=.014\textwidth,clip=true,trim={0 .59cm 9cm 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_l2_u2_C7_gaussian_kernel_shape_0.78125_Poly-1.pdf}}   & {\includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_l2_u2_C7_gaussian_kernel_shape_0.78125_Poly-1.pdf}} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_l2_u2_C11_gaussian_kernel_shape_1.5625_Poly-1.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_l2_u2_C15_gaussian_kernel_shape_2.5_Poly-1.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_l2_u2_C20_gaussian_kernel_shape_3.6621_Poly-1.pdf} \\
     {\includegraphics[width=.014\textwidth,clip=true,trim={0 0 9cm 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_l2_u2_C7_gaussian_kernel_shape_0.78125_Poly-1.pdf}} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_l2_u2_C30_gaussian_kernel_shape_5.6152_Poly-1.pdf}  & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_l2_u2_C40_gaussian_kernel_shape_7.8125_Poly-1.pdf}  & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_l2_u2_C50_gaussian_kernel_shape_9.7656_Poly-1.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_l2_u2_C60_gaussian_kernel_shape_11.7188_Poly-1.pdf}   \\
  \end{tabular}
...
\begin{sidewaysfigure}[H]
  \hspace*{-1cm}
  \begin{tabular}{ccccc}
    {\includegraphics[width=.014\textwidth,clip=true,trim={0 .59cm 9cm 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_linf_u2_C7_gaussian_kernel_shape_0.78125_Poly2.pdf}} & {\includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_linf_u2_C7_gaussian_kernel_shape_0.78125_Poly2.pdf}}   & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_linf_u2_C11_gaussian_kernel_shape_1.5625_Poly2.pdf}   & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_linf_u2_C15_gaussian_kernel_shape_2.5_Poly2.pdf}   & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_linf_u2_C20_gaussian_kernel_shape_3.6621_Poly2.pdf}   \\
    {\includegraphics[width=.014\textwidth,clip=true,trim={0 .59cm 9cm 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_linf_u2_C7_gaussian_kernel_shape_0.78125_Poly2.pdf}} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_linf_u2_C30_gaussian_kernel_shape_5.6152_Poly2.pdf}   & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_linf_u2_C40_gaussian_kernel_shape_7.8125_Poly2.pdf}  & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_linf_u2_C50_gaussian_kernel_shape_9.7656_Poly2.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_linf_u2_C60_gaussian_kernel_shape_11.7188_Poly2.pdf}   \\ \hline
     {\includegraphics[width=.014\textwidth,clip=true,trim={0 .59cm 9cm 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_l2_u2_C7_gaussian_kernel_shape_0.78125_Poly2.pdf}}   & {\includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_l2_u2_C7_gaussian_kernel_shape_0.78125_Poly2.pdf}} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_l2_u2_C11_gaussian_kernel_shape_1.5625_Poly2.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_l2_u2_C15_gaussian_kernel_shape_2.5_Poly2.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler_interpolation/violins/violins_l2_u2_C20_gaussian_kernel_shape_3.6621_Poly2.pdf} \\
...
\begin{sidewaysfigure}[H]
  ...
  \begin{tabular}{cccccc}
    ...
    {\includegraphics[width=.014\textwidth,clip=true,trim={0 0 9.3cm 0}]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/parabola/violins/violins_l2_parabola_C49_gaussian_kernel_shape_1.3428_Poly-1.pdf}} & {\includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/parabola/violins/violins_l2_parabola_C49_gaussian_kernel_shape_1.3428_Poly-1.pdf}} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/parabola/violins/violins_l2_parabola_C81_gaussian_kernel_shape_1.9531_Poly-1.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/parabola/violins/violins_l2_parabola_C121_gaussian_kernel_shape_2.5635_Poly-1.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/parabola/violins/violins_l2_parabola_C169_gaussian_kernel_shape_3.1738_Poly-1.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/parabola/violins/violins_l2_parabola_C225_gaussian_kernel_shape_3.6621_Poly-1.pdf} \\
...
\begin{sidewaysfigure}[H]
  ...
  \begin{tabular}{cccccc}
    ...
    {\includegraphics[width=.014\textwidth,clip=true,trim={0 0 9.3cm 0}]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/parabola/violins/violins_l2_parabola_C49_gaussian_kernel_shape_1.3428_Poly2.pdf}} & {\includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/parabola/violins/violins_l2_parabola_C49_gaussian_kernel_shape_1.3428_Poly2.pdf}} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/parabola/violins/violins_l2_parabola_C81_gaussian_kernel_shape_1.9531_Poly2.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/parabola/violins/violins_l2_parabola_C121_gaussian_kernel_shape_2.5635_Poly2.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/parabola/violins/violins_l2_parabola_C169_gaussian_kernel_shape_3.1738_Poly2.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/parabola/violins/violins_l2_parabola_C225_gaussian_kernel_shape_3.6621_Poly2.pdf} \\
...
\begin{sidewaysfigure}[H]
  \hspace*{-1cm}
  \begin{tabular}{ccccc}
    {\includegraphics[width=.2\textwidth, clip=true,trim={0 0 2.1cm 0}]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/parabola/parabola_49_-1.pdf}} & {\includegraphics[width=.2\textwidth, clip=true,trim={0 0 2.1cm 0}]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/parabola/parabola_81_-1.pdf}} & {\includegraphics[width=.2\textwidth, clip=true,trim={0 0 2.1cm 0}]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/parabola/parabola_121_-1.pdf}} & {\includegraphics[width=.2\textwidth, clip=true,trim={0 0 2.1cm 0}]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/parabola/parabola_169_-1.pdf}} & {\includegraphics[width=.2\textwidth, clip=true,trim={0 0 2.1cm 0}]{imagenes/experiments/2d/statistical_2d_full_scheduler_interpolation/parabola/parabola_225_-1.pdf}} \\
...
\begin{sidewaysfigure}[H]
  ...
  \begin{tabular}{ccccc}
    ...
    {\includegraphics[width=.014\textwidth,clip=true,trim={0 .59cm 9cm 0}]{imagenes/experiments/1d/ode/violins_linf_u_xx-2_C7_gaussian_kernel_shape_0.78125_Poly-1.pdf}} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 0}]{imagenes/experiments/1d/ode/violins_linf_u_xx-2_C30_gaussian_kernel_shape_5.16_Poly-1.pdf}   & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 0}]{imagenes/experiments/1d/ode/violins_linf_u_xx-2_C40_gaussian_kernel_shape_7.03_Poly-1.pdf}  & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 0}]{imagenes/experiments/1d/ode/violins_linf_u_xx-2_C50_gaussian_kernel_shape_8.89_Poly-1.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 0}]{imagenes/experiments/1d/ode/violins_linf_u_xx-2_C60_gaussian_kernel_shape_10.74_Poly-1.pdf}   \\ \hline
     {\includegraphics[width=.014\textwidth,clip=true,trim={0 .59cm 9cm 0}]{imagenes/experiments/1d/ode/violins_l2_u_xx-2_C7_gaussian_kernel_shape_0.78125_Poly-1.pdf}}   & {\includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/ode/violins_l2_u_xx-2_C7_gaussian_kernel_shape_0.78125_Poly-1.pdf}} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/ode/violins_l2_u_xx-2_C11_gaussian_kernel_shape_1.5625_Poly-1.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/ode/violins_l2_u_xx-2_C15_gaussian_kernel_shape_2.5_Poly-1.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/ode/violins_l2_u_xx-2_C20_gaussian_kernel_shape_3.23_Poly-1.pdf} \\
...
\begin{sidewaysfigure}[H]
  \hspace*{-1cm}
  \begin{tabular}{ccccc}
    {\includegraphics[width=.014\textwidth,clip=true,trim={0 .59cm 9cm 0}]{imagenes/experiments/1d/ode/violins_linf_u_xx-2_C7_gaussian_kernel_shape_0.78125_Poly2.pdf}} & {\includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/ode/violins_linf_u_xx-2_C7_gaussian_kernel_shape_0.78125_Poly2.pdf}}   & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/ode/violins_linf_u_xx-2_C11_gaussian_kernel_shape_1.5625_Poly2.pdf}   & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/ode/violins_linf_u_xx-2_C15_gaussian_kernel_shape_2.5_Poly2.pdf}   & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/ode/violins_linf_u_xx-2_C20_gaussian_kernel_shape_3.6621_Poly2.pdf}   \\
    {\includegraphics[width=.014\textwidth,clip=true,trim={0 .59cm 9cm 0}]{imagenes/experiments/1d/ode/violins_linf_u_xx-2_C7_gaussian_kernel_shape_0.78125_Poly2.pdf}} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 0}]{imagenes/experiments/1d/ode/violins_linf_u_xx-2_C30_gaussian_kernel_shape_5.6152_Poly2.pdf}   & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 0}]{imagenes/experiments/1d/ode/violins_linf_u_xx-2_C40_gaussian_kernel_shape_7.8125_Poly2.pdf}  & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 0}]{imagenes/experiments/1d/ode/violins_linf_u_xx-2_C50_gaussian_kernel_shape_9.7656_Poly2.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 0}]{imagenes/experiments/1d/ode/violins_linf_u_xx-2_C60_gaussian_kernel_shape_11.7188_Poly2.pdf}   \\ \hline
     {\includegraphics[width=.014\textwidth,clip=true,trim={0 .59cm 9cm 0}]{imagenes/experiments/1d/ode/violins_l2_u_xx-2_C7_gaussian_kernel_shape_0.78125_Poly2.pdf}}   & {\includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/ode/violins_l2_u_xx-2_C7_gaussian_kernel_shape_0.78125_Poly2.pdf}} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/ode/violins_l2_u_xx-2_C11_gaussian_kernel_shape_1.5625_Poly2.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/ode/violins_l2_u_xx-2_C15_gaussian_kernel_shape_2.5_Poly2.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm .59cm 0 0}]{imagenes/experiments/1d/ode/violins_l2_u_xx-2_C20_gaussian_kernel_shape_3.6621_Poly2.pdf} \\
...
\begin{sidewaysfigure}[H]
  ...
  \begin{tabular}{cccccc}
    ...
    {\includegraphics[width=.014\textwidth,clip=true,trim={0 0 9cm 0}]{imagenes/experiments/2d/pde_parabola/violins_l2_parabola_C49_gaussian_kernel_shape_1.3428_Poly-1.pdf}}   & {\includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/2d/pde_parabola/violins_l2_parabola_C49_gaussian_kernel_shape_1.3428_Poly-1.pdf}} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/2d/pde_parabola/violins_l2_parabola_C81_gaussian_kernel_shape_1.9531_Poly-1.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/2d/pde_parabola/violins_l2_parabola_C121_gaussian_kernel_shape_2.5635_Poly-1.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/2d/pde_parabola/violins_l2_parabola_C169_gaussian_kernel_shape_3.1738_Poly-1.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/2d/pde_parabola/violins_l2_parabola_C225_gaussian_kernel_shape_3.6621_Poly-1.pdf} \\
...
\begin{sidewaysfigure}[H]
  ...
  \begin{tabular}{cccccc}
    ...
    {\includegraphics[width=.014\textwidth,clip=true,trim={0 0 9cm 0}]{imagenes/experiments/2d/pde_parabola/violins_l2_parabola_C49_gaussian_kernel_shape_1.3428_Poly2.pdf}}   & {\includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/2d/pde_parabola/violins_l2_parabola_C49_gaussian_kernel_shape_1.3428_Poly2.pdf}} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/2d/pde_parabola/violins_l2_parabola_C81_gaussian_kernel_shape_1.9531_Poly2.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/2d/pde_parabola/violins_l2_parabola_C121_gaussian_kernel_shape_2.5635_Poly2.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/2d/pde_parabola/violins_l2_parabola_C169_gaussian_kernel_shape_3.1738_Poly2.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/2d/pde_parabola/violins_l2_parabola_C225_gaussian_kernel_shape_3.6621_Poly2.pdf} \\
...
% \hspace*{-1cm}
% \begin{tabular}{cc}
% % {\includegraphics[width=.13\textwidth]{imagenes/experiments/2d/heat_1d/49_100_colorbar.pdf}}    &
%   % \frame
...
%     % & {\includegraphics[width=.3\textwidth]{imagenes/experiments/2d/heat_1d/model_curves_legend_2_2.pdf}} & {\includegraphics[width=.3\textwidth]{imagenes/experiments/2d/heat_1d/trained_shapes_cbar.pdf}}
% \end{tabular}
...
\begin{itemize}
  ...
  \item Due to the iterative nature of the development process we have followed, our attempt at solving the 1D wave equation and the 1D heat equation set us out to propose alternative graphic representations of the shape parameters and the coefficients to get a better understanding of our model. This implies that improvements can be made to the way information is portrayed for this RBF-based model.
  
  \item Furthermore, the actual solution of the 1D wave equation is a Gaussian travelling wave. In order to reliably reproduce this travelling wave, it should suffice to consider two shape parameters: one ``along'' the $x$ axis, which would scale the distance along this axis, and another one for the $y$ axis. Although this could be done by committing precise modifications to the already existing codebase, it poses new questions about suitable starting shape parameters which would result in an in-depth study.
  
  \item Even before posing the model, the proposed radial basis functions failed to solve problems involving functions which are not in $C^\infty$, such as the sign function (recall e.g. Figure \ref{fig:sign-with-20-pts}). This overwhelmingly narrows down the function space we can approximate. A future work could therefore involve the consideration of other radial functions, like the hat function. As the code base is structured, defining and swapping the kernel would suffice to tackle the idea.
%  usar datos experimentales en la pde para entrenar mejor 
  \item The differential problems we have attempted to solve are the so-called forward problems, where the parameters of the problem (say, diffusive constant) are predetermined by the physics. Future works could involve inverse problems, where these constants are to be found up to particular measurements of the phenomenon under study.
\end{itemize}
