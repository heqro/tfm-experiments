...
\end{tabular}
\caption{Comparison of the average absolute error, with the incorrect (left-hand side) and the correct attemps (right-hand side).}
...
\begin{itemize}
  ...
  \item Likewise, many centers are observed to be outside of the domain. This is especially true for the case of the heat equation, whereby the centers were found outside of the domain to most reliably reproduce the rather ``aggressive'' changes in the gradient of the actual solution.
\end{itemize}
...
\begin{itemize}
  ...
  \item Furthermore, the actual solution of the 1D wave equation is a Gaussian travelling wave. In order to reliably reproduce this travelling wave, it would suffice to consider two shape parameters: one ``along'' the $x$ axis, which scales the distance along this axes, and another for the $y$ axis. 
