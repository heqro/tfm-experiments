...
\begin{enumerate}
  ...
  \item Discuss the present developmental stage of our methodology involving an RBF-based neural network, detailing the thought process behind its most relevant features as well as describing problems that have been observed before the due date of the thesis. This in Chapter \ref{chap:preliminary-experimentation}.
