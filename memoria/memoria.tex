...
\begin{itemize}
  ...
  \item The learning curves indicate that the $L^\infty-$norm as well as the MSE decrease, but the
  former is stabilizing on a plateau towards the end of the training process. The action 
  of the Adam optimizer explains the ``spikes'' showing up every few iterations.
\end{itemize}
