...
training points. To account for the hardware capabilities as in Table 
\ref{tb:hardware-machinery}, each experiment triple determined by function, $C$ and $k$ is 
repeated $160$ times. These experiments are launched in $32$ separate
processes, with 5 experiments each. 
...
\begin{figure}[H]
  ...
  {\includegraphics[height=.45\textwidth]
  {imagenes/experiments/1d/statistical_1d_full/medians_linf_sin_pi_x_sq_gaussian_kernel.pdf}}
...
\begin{figure}[H]
  ...
  {\includegraphics[height=.45\textwidth]
  {imagenes/experiments/1d/statistical_1d_full/medians_epochs_sin_pi_x_sq_gaussian_kernel.pdf}}
  \caption{Medians of the best epochs' ratio.}
  \label{fig:medians-epochs-statistic}
\end{figure}

\texttt{surplus information - No cabría}

\begin{figure}[H]
  % \frame
  {\includegraphics[width=.45\textwidth]
  {imagenes/experiments/1d/statistical_1d_full/linf_violins_C7_runge_function_gaussian_kernel.pdf}}
  {\includegraphics[width=.45\textwidth]
  {imagenes/experiments/1d/statistical_1d_full/linf_violins_C9_runge_function_gaussian_kernel.pdf}}
  {\includegraphics[width=.45\textwidth]
  {imagenes/experiments/1d/statistical_1d_full/linf_violins_C11_runge_function_gaussian_kernel.pdf}}
  {\includegraphics[width=.45\textwidth]
  {imagenes/experiments/1d/statistical_1d_full/linf_violins_C13_runge_function_gaussian_kernel.pdf}}
  {\includegraphics[width=.45\textwidth]
  {imagenes/experiments/1d/statistical_1d_full/linf_violins_C15_runge_function_gaussian_kernel.pdf}}
  \caption{$L^\infty-$norms for Runge's function.}
  \label{fig:epochs-violins-runge}
\end{figure}

\begin{figure}[H]
  % \frame
  {\includegraphics[width=.45\textwidth]
  {imagenes/experiments/1d/statistical_1d_full/epochs_violins_C7_runge_function_gaussian_kernel.pdf}}
  {\includegraphics[width=.45\textwidth]
  {imagenes/experiments/1d/statistical_1d_full/epochs_violins_C9_runge_function_gaussian_kernel.pdf}}
  {\includegraphics[width=.45\textwidth]
  {imagenes/experiments/1d/statistical_1d_full/epochs_violins_C11_runge_function_gaussian_kernel.pdf}}
  {\includegraphics[width=.45\textwidth]
  {imagenes/experiments/1d/statistical_1d_full/epochs_violins_C13_runge_function_gaussian_kernel.pdf}}
  {\includegraphics[width=.45\textwidth]
  {imagenes/experiments/1d/statistical_1d_full/epochs_violins_C15_runge_function_gaussian_kernel.pdf}}
  \caption{Epochs' ratios for Runge's function.}
  \label{fig:epochs-violins-runge}
\end{figure}
...
\begin{figure}[H]
  % \frame
  {\includegraphics[width=.45\textwidth]
  {imagenes/experiments/1d/statistical_1d_full/linf_violins_C7_sin_pi_x_sq_gaussian_kernel.pdf}}
  {\includegraphics[width=.45\textwidth]
  {imagenes/experiments/1d/statistical_1d_full/linf_violins_C9_sin_pi_x_sq_gaussian_kernel.pdf}}
  {\includegraphics[width=.45\textwidth]
  {imagenes/experiments/1d/statistical_1d_full/linf_violins_C11_sin_pi_x_sq_gaussian_kernel.pdf}}
  {\includegraphics[width=.45\textwidth]
  {imagenes/experiments/1d/statistical_1d_full/linf_violins_C13_sin_pi_x_sq_gaussian_kernel.pdf}}
  {\includegraphics[width=.45\textwidth]
  {imagenes/experiments/1d/statistical_1d_full/linf_violins_C15_sin_pi_x_sq_gaussian_kernel.pdf}}
  \caption{$L^\infty-$norms for \texttt{sin\_pi\_x\_sq}.}
  \label{fig:epochs-violins-sin-pi-x-sq}
\end{figure}

\begin{figure}[H]
  % \frame
  {\includegraphics[width=.45\textwidth]
  {imagenes/experiments/1d/statistical_1d_full/epochs_violins_C7_sin_pi_x_sq_gaussian_kernel.pdf}}
  {\includegraphics[width=.45\textwidth]
  {imagenes/experiments/1d/statistical_1d_full/epochs_violins_C9_sin_pi_x_sq_gaussian_kernel.pdf}}
  {\includegraphics[width=.45\textwidth]
  {imagenes/experiments/1d/statistical_1d_full/epochs_violins_C11_sin_pi_x_sq_gaussian_kernel.pdf}}
  {\includegraphics[width=.45\textwidth]
  {imagenes/experiments/1d/statistical_1d_full/epochs_violins_C13_sin_pi_x_sq_gaussian_kernel.pdf}}
  {\includegraphics[width=.45\textwidth]
  {imagenes/experiments/1d/statistical_1d_full/epochs_violins_C15_sin_pi_x_sq_gaussian_kernel.pdf}}
  \caption{Epochs' ratios for \texttt{sin\_pi\_x\_sq}.}
  \label{fig:epochs-violins-sin-pi-x-sq}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Results of the interpolation of the Runge function (5 centers).
    Left-hand side: distribution of centers with respect to the problem domain (green rectangle). Center: the best epoch to total epochs' ratio.
...
\begin{figure}[H]
  % \frame
  {\includegraphics[width=\textwidth, trim={2cm 0 2.8cm 0}, clip=true]{imagenes/experiments/2d/franke_interpolation/tr12_c5_franke_mq.pdf}}
  \caption{Results of the interpolation of the Runge function (5 centers).
    Left-hand side: distribution of centers with respect to the problem domain (green rectangle). Center: the best epoch to total epochs' ratio.
    Right-hand side: $\log_{10}(L^\infty-\text{norm})$.}
...
\begin{figure}[H]
  \includegraphics[width=\textwidth, trim={2cm 0 2.8cm 0}, clip=true]{imagenes/experiments/2d/franke_interpolation/tr12_c6_franke_mq.pdf}
  \caption{Results of the interpolation of the Runge function (6 centers).
    Left-hand side: distribution of centers with respect to the problem domain (green rectangle). Center: the best epoch to total epochs' ratio.
    Right-hand side: $\log_{10}(L^\infty-\text{norm})$.}
...
\end{figure}
\begin{figure}[H]
  \includegraphics[width=\textwidth, trim={2cm 0 2.8cm 0}, clip=true]{imagenes/experiments/2d/franke_interpolation/tr12_c7_franke_mq.pdf}
  \caption{Results of the interpolation of the Runge function (7 centers).
    Left-hand side: distribution of centers with respect to the problem domain (green rectangle). Center: the best epoch to total epochs' ratio.
    Right-hand side: $\log_{10}(L^\infty-\text{norm})$.}
...
\end{figure}
\begin{figure}[H]
  \includegraphics[width=\textwidth, trim={2cm 0 2.8cm 0}, clip=true]{imagenes/experiments/2d/franke_interpolation/tr12_c8_franke_mq.pdf}
  \caption{Results of the interpolation of the Runge function (8 centers).
    Left-hand side: distribution of centers with respect to the problem domain (green rectangle). Center: the best epoch to total epochs' ratio.
    Right-hand side: $\log_{10}(L^\infty-\text{norm})$.}
...
\end{figure}
\begin{figure}[H]
  \includegraphics[width=\textwidth, trim={2cm 0 2.8cm 0}, clip=true]{imagenes/experiments/2d/franke_interpolation/tr12_c9_franke_mq.pdf}
  \caption{Results of the interpolation of the Runge function (9 centers).
    Left-hand side: distribution of centers with respect to the problem domain (green rectangle). Center: the best epoch to total epochs' ratio.
    Right-hand side: $\log_{10}(L^\infty-\text{norm})$.}
...
\end{figure}
\begin{figure}[H]
  \includegraphics[width=\textwidth, trim={2cm 0 2.8cm 0}, clip=true]{imagenes/experiments/2d/franke_interpolation/tr12_c10_franke_mq.pdf}
  \caption{Results of the interpolation of the Runge function (10 centers).
    Left-hand side: distribution of centers with respect to the problem domain (green rectangle). Center: the best epoch to total epochs' ratio.
    Right-hand side: $\log_{10}(L^\infty-\text{norm})$.}
...
\end{figure}
\begin{figure}[H]
  \includegraphics[width=\textwidth, trim={2cm 0 2.8cm 0}, clip=true]{imagenes/experiments/2d/franke_interpolation/tr12_c11_franke_mq.pdf}
  \caption{Results of the interpolation of the Runge function (11 centers).
    Left-hand side: distribution of centers with respect to the problem domain (green rectangle). Center: the best epoch to total epochs' ratio.
    Right-hand side: $\log_{10}(L^\infty-\text{norm})$.}
...
\end{figure}
\begin{figure}[H]
  \includegraphics[width=\textwidth, trim={2cm 0 2.8cm 0}, clip=true]{imagenes/experiments/2d/franke_interpolation/tr12_c12_franke_mq.pdf}
  \caption{Results of the interpolation of the Runge function (12 centers).
    Left-hand side: distribution of centers with respect to the problem domain (green rectangle). Center: the best epoch to total epochs' ratio.
    Right-hand side: $\log_{10}(L^\infty-\text{norm})$.}
