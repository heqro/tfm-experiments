...
% Like in the previous exercise for the heat equation, we have observed that the 
...
\begin{figure}
  ...
  \end{tabular}
  \caption{Left-hand side: 2D histogram of centers across all training instances, distinguishing between those experiments that did not work out correctly (left) and those that did (right).}
