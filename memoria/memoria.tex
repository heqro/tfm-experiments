...
Figure \ref{fig:u2-results-shapes-etc-c60-tr240} depicts a histogram of the trained centers by the end of all training instances, alongside violin plots of the shapes and coefficients. This is the experiment featuring the largest amount of centers and training points. Some immediate observations about this Figure are the following: \begin{itemize}
