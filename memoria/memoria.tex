...
\begin{itemize}
  ...
  \item The explicit incorporation of a bias term term has a positive effect on the interpolation, reducing the previously-observed plateau while providing another digit of accuracy in the worst-case scenario. This plateau is further reduced when considering a linear polynomial.
