...
\begin{figure}[h]
  % \frame
  \hspace*{-1cm}
  {\includegraphics[width=.42\textwidth,clip=true,trim={0 0 2cm 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler/comparison-linf.pdf}}
  % \frame
  {\includegraphics[width=.42\textwidth,clip=true,trim={0 0 2cm 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler/comparison-l2.pdf}}
  % \frame
  {\includegraphics[width=.08\textwidth,clip=true,trim={12.1cm 1cm 0 1cm}]{imagenes/experiments/1d/statistical_1d_full_scheduler/comparison-l2.pdf}}
...
\begin{figure}[h]
  ...
  {\includegraphics[width=.6\textwidth,clip=true,trim={0 0 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler/distribution_of_shape_parameters_at_end_of_training.pdf}}
...
\begin{figure}[h]
  % \frame
  {\includegraphics[width=.4\textwidth,clip=true,trim={0 0 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler/medians_linf_u2_gaussian_kernel_Poly-1_uniform.pdf}}
  {\includegraphics[width=.4\textwidth,clip=true,trim={0 0 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler/medians_linf_u2_gaussian_kernel_Poly2_uniform.pdf}}
  \caption{Distribution of shape parameters at the end of the training process.}
...
\begin{figure}[h]
  % \frame
  {\includegraphics[width=.4\textwidth,clip=true,trim={0 0 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler/medians_l2_u2_gaussian_kernel_Poly-1_uniform.pdf}}
  {\includegraphics[width=.4\textwidth,clip=true,trim={0 0 0 0}]{imagenes/experiments/1d/statistical_1d_full_scheduler/medians_l2_u2_gaussian_kernel_Poly2_uniform.pdf}}
  \caption{Distribution of shape parameters at the end of the training process.}
