...
\begin{sidewaysfigure}[H]
  ...
  \begin{tabular}{cccccc}
    ...
    {\includegraphics[width=.014\textwidth,clip=true,trim={0 0 9cm 0}]{imagenes/experiments/1d/ode/violins_l2_u_xx-2_C7_gaussian_kernel_shape_0.78125_Poly-1.pdf}}   & {\includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/1d/ode/violins_l2_u_xx-2_C7_gaussian_kernel_shape_0.78125_Poly-1.pdf}} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/1d/ode/violins_l2_u_xx-2_C11_gaussian_kernel_shape_1.5625_Poly-1.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/1d/ode/violins_l2_u_xx-2_C15_gaussian_kernel_shape_2.5_Poly-1.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/1d/ode/violins_l2_u_xx-2_C20_gaussian_kernel_shape_3.6621_Poly-1.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/1d/ode/violins_l2_u_xx-2_C30_gaussian_kernel_shape_5.6152_Poly-1.pdf} \\
  \end{tabular}
  \caption{Distribution of the $L^\infty$, $L^2-$norms on our verification dataset without a polynomial term.}
...
\begin{sidewaysfigure}[H]
  ...
  \begin{tabular}{cccccc}
    ...
    {\includegraphics[width=.014\textwidth,clip=true,trim={0 0 9cm 0}]{imagenes/experiments/1d/ode/violins_l2_u_xx-2_C7_gaussian_kernel_shape_0.78125_Poly2.pdf}}   & {\includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/1d/ode/violins_l2_u_xx-2_C7_gaussian_kernel_shape_0.78125_Poly2.pdf}} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/1d/ode/violins_l2_u_xx-2_C11_gaussian_kernel_shape_1.5625_Poly2.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/1d/ode/violins_l2_u_xx-2_C15_gaussian_kernel_shape_2.5_Poly2.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/1d/ode/violins_l2_u_xx-2_C20_gaussian_kernel_shape_3.6621_Poly2.pdf} & \includegraphics[width=.2\textwidth,clip=true,trim={.81cm 0 0 .65cm}]{imagenes/experiments/1d/ode/violins_l2_u_xx-2_C30_gaussian_kernel_shape_5.6152_Poly2.pdf} \\
  \end{tabular}
  \caption{Distribution of the $L^\infty$, $L^2-$norms on our verification dataset
    with a quadratic polynomial term (bottom section).}
...
As a sidenote, if $\alpha$ would depend on $x$ and $t$, this formulation could easily be modified by just introducing $\alpha=\alpha(\mathcal{I})$ in the first addend instead, the product then being the element-wise product between vectors.
